                            ...
                            <?php foreach ($latest_blogs as $blog) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-sm read-more text-info font-weight-bold" data-toggle="modal" data-target="#blogModalWide_<?php echo $blog->blogId; ?>">
                                            Read more
                                        </a>
                                    </td>
                                ...
                                <!-- Modal for each blog -->
                                <div class="modal fade" id="blogModalWide_<?php echo $blog->blogId; ?>" tabindex="-1" role="dialog" aria-labelledby="blogModalLabelWide_<?php echo $blog->blogId; ?>" aria-hidden="true">
